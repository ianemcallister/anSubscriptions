...
function mainController(e,n,o,t,i,r,a){e.userData=i,e.state=r,e.$on("$viewContentLoaded",function(){console.log("$viewContentLoaded, testing testing"),a.init()})}ahNuts.controller("mainController",mainController),mainController.$inject=["$scope","$log","$location","submissionService","userDataService","stateService","squareService"];
