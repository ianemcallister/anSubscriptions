...
function mainController(e,o,n,t,r,i,s){e.userData=r,e.state=i,e.$on("$viewContentLoaded",function(){console.log("$viewContentLoaded"),console.log("got these codes:",JSON.parse(process.env.PROMO_CODES)),s.init()})}ahNuts.controller("mainController",mainController),mainController.$inject=["$scope","$log","$location","submissionService","userDataService","stateService","squareService"];
...
function productSelection(){t.$inject=["scope","el","attr","ctrl"];var e={restrict:"AECM",templateUrl:"views/productSelection.htm",replace:!0,scope:{},link:t,controller:r,controllerAs:"vm",bindToController:!0};function t(e,t,r,o){}function r(t,e,r,o,i,s){var c=this;c.userData=r,c.state=o.productSelection,c.state.infoBox=o.infoBoxes.flavorDefs,i.download.productList().then(function(e){c.flavors=e,t.$apply()}).catch(function(e){console.log("product list error, ",e)}),c.orderList=r.order,c.productPrice=1699,c.order=r.tender;var a={id:1,sqrId:"",sqVarId:"",flavor:"",mixflvrCount:0,mixflvrs:{srpec:{id:"srpec",name:"SR Pecans",selected:!1,classes:{"list-group-item":!0,active:!1}},sralm:{id:"sralm",name:"SR Almonds",selected:!1,classes:{"list-group-item":!0,active:!1}},srcsh:{id:"srcsh",name:"SR Cashews",selected:!1,classes:{"list-group-item":!0,active:!1}},srpea:{id:"srpea",name:"SR Peanuts",selected:!1,classes:{"list-group-item":!0,active:!1}},cnpec:{id:"cnpec",name:"Cin Pecans",selected:!1,classes:{"list-group-item":!0,active:!1}},cnalm:{id:"cnalm",name:"Cin Almonds",selected:!1,classes:{"list-group-item":!0,active:!1}},drpec:{id:"drpec",name:"Drunk Pecans",selected:!1,classes:{"list-group-item":!0,active:!1}}},mixFlvrsSelected:[],mix:""};function d(){c.order.total=c.orderList.length*c.productPrice-c.order.discounts,4==c.orderList.length&&(c.order.total=c.order.total-c.productPrice)}c.addAProduct=function(){var e=c.orderList.length;e<4&&c.orderList.push(Object.create(a)),3==e&&(c.state.addAProductBtn.visible=!1),0<e&&(c.state.removeLastProductBtn.visible=!0);for(var t=0;t<=e;t++)c.orderList[t].id=t+1;d()},c.removeLastProduct=function(){var e=c.orderList.length,t=e-1;1<e&&c.orderList.splice(t,1),2==e&&(c.state.removeLastProductBtn.visible=!1),c.state.addAProductBtn.visible=!0,4==e&&(c.order.discounts=0),d()},c.removeAProduct=function(e){var t=e-1;1<c.orderList.length&&c.orderList.splice(t,1);for(var r=0;r<=c.orderList.length-1;r++)c.orderList[r].id=r+1;d()},c.validateProducts=function(){},c.countMixFlavors=function(t){var r=0;return Object.keys(t).forEach(function(e){t[e].selected&&r++}),r},c.updateShoppingCart=function(){c.orderList.forEach(function(t){c.flavors.forEach(function(e){e.name==t.flavor&&(t.sqrId=e.id,t.id<4?t.sqVarId=e.variations[0].id:t.sqVarId=e.variations[1].id)})})},c.buildFlavorList=function(t){c.orderList[t].mixFlvrsSelected=[],Object.keys(c.orderList[t].mixflvrs).forEach(function(e){c.orderList[t].mixflvrs[e].selected&&c.orderList[t].mixFlvrsSelected.push(c.orderList[t].mixflvrs[e].name)})},c.checkPromoCode=function(e){s.get.checkPromoCode(e).then(function(e){c.state.promoCode.input["is-invalid"]=e?(c.state.promoCode.input["was-validated"]=!0,c.state.promoCode.input["needs-validation"]=!1,!(c.state.promoCode.input["is-valid"]=!0)):(c.state.promoCode.input["was-validated"]=!0,c.state.promoCode.input["needs-validation"]=!1,!(c.state.promoCode.input["is-valid"]=!1)),t.$apply()}).catch(function(e){console.log("Error",e)})},c.orderList.push(Object.create(a)),d()}return r.$inject=["$scope","$log","userDataService","stateService","squareService","serverService"],e}angular.module("ansub").directive("productSelection",productSelection);
...
function subTermsCond(){r.$inject=["scope","el","attr","ctrl"];var e={restrict:"AECM",templateUrl:"views/subTermsCond.htm",replace:!0,scope:{},link:r,controller:t,controllerAs:"vm",bindToController:!0};function r(e,r,t,s){}function t(e,r,t,s,i,n,o,a){var c=this;c.state=s,c.userData=i,c.validate=n,c.square=a}return t.$inject=["$scope","$log","$location","stateService","userDataService","validationService","submissionService","squareService"],e}angular.module("ansub").directive("subTermsCond",subTermsCond);
